...
import PpcServices from "../../components/ui/ppc/PpcServices";
import PpcWhyChoose from "../PpcWhyChooseUs";
import PpcHowWeWork from "../../components/ui/ppc/PpcHowWeWork";
import IndustriesSection from "../DigitalMarketingAgencyinRajkot/IndustriesSection";
import {
  TrendingUp,
  Target,
  ArrowRight,
...
export default function SeoHeroSection() {
  ...
  return (
    <>
      ...
      <header
        role="banner"
        className="relative min-h-[100vh] overflow-hidden bg-white  text-[#111]  flex flex-col justify-center"
      >
