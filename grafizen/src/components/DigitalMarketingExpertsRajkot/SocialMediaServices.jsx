...
const services = [
  {
    ...
    description:
      "We build tailored content calendars aligned with your revenue goals.",
    image: strategy,
    accent: "#DD0403",
  ...
  },
  {
    ...
    description:
      "Custom-designed posts, reels, and stories that make your brand stand out.",
    image: branding,
    accent: "#DD0403",
    softAccent: "rgba(221, 4, 3, 0.08)",
  },
  {
    ...
    description:
      " Complete cleanup of your bios, highlights, and links for maximum conversions.",
    image: webpage,
    accent: "#DD0403",
    softAccent: "rgba(221, 4, 3, 0.08)",
  },
  {
    ...
    description:
      "Consistent posting and active community engagement to grow your reach.",
    image: increase,
    accent: "#DD0403",
    softAccent: "rgba(221, 4, 3, 0.08)",
  },
...
export default function SocialMediaServices() {
  ...
  return (
    <section
      ref={sectionRef}
      className="relative w-full overflow-hidden bg-white px-4 py-10 sm:px-6 md:px-8 lg:px-12 lg:py-16 xl:px-20"
    >
      ...
      <div className="relative mx-auto max-w-[1400px]">
        ...
        ====================================================== */}
        <div
          className={`grid grid-cols-1 md:gap-10  transition-all duration-1000 ease-out lg:grid-cols-[1.2fr_0.8fr] lg:items-end ${
        ...
        >
          ...
          <div>
            ...
            {/* Heading */}
            <h2 className="max-w-5xl md:text-[48px] text-[28px] font-medium leading-[0.92] tracking-[-0.055em] text-[#111111]">
              Social Media That
...
mt-6 max-w-3xl text-base leading-5 text-neutral-500 sm:text-md text-black/55 text-[13px] font-[300]">
              ...
              We manage, design, and grow your brand across all social platforms to convert followers into paying customers.
            </p>
          </div>
        </div>
        ...
        ====================================================== */}
        <div
          className={`mt-4 transition-all delay-300 duration-1000 sm:mt-24 lg:mt-10 ${
        ...
        {/* =====================================================
            SERVICE GRID
        ====================================================== */}
        <div className="md:mt-16 mt-8  grid grid-cols-1 gap-3 md:grid-cols-2 md:gap-4 xl:grid-cols-4 xl:gap-4">
...
function ServiceCard({ service, index, isVisible }) {
  return (
    <div
      className={`group relative overflow-hidden md:rounded-[24px] rounded-[15px] border border-black/10 bg-white p-4 shadow-[0_14px_28px_rgba(17,17,17,0.03)] transition-all duration-700 ease-out hover:-translate-y-2 hover:shadow-[0_22px_48px_rgba(17,17,17,0.08)] sm:p-6 lg:p-5 ${
        index % 2 === 0 ? "lg:min-h-[200px]" : "lg:min-h-[200px]"
      } ${
    ...
    >
      ...
      <div
        className="pointer-events-none absolute -right-10 -top-10 md:h-30 md:w-30 h-26 w-26 rounded-full border border-black/5"
        style={{
          background: `${service.softAccent}`,
          boxShadow: `0 0 0 12px ${service.softAccent}`,
        }}
      />
      <div className="pointer-events-none absolute bottom-0 left-0 md:h-20 md:w-20 h-16 w-16 rounded-tr-[32px] bg-white/30" />
      ...
      <div className="relative z-10 flex items-start justify-between gap-4">
        ...
        <div
          className="flex items-center justify-center  text-white  transition-all duration-500 group-hover:rotate-6 group-hover:scale-105 absolute -right-2 -top-1"
          style={{
